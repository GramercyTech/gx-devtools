...
describe("extract-config", () => {
  ...
  describe("extractFromScript patterns", () => {
    ...
    it("should match getSetting calls", () => {
      const content =
        "const color = store.getSetting('primary_color', '#FF0000');";
      const regex =
    ...
    it("should match getAsset calls", () => {
      const content =
        "const logo = store.getAsset('logo', '/images/logo.png');";
      const regex =
    ...
    it("should match listenSocket calls", () => {
      const content =
        "store.listenSocket('notifications', 'new-message', callback);";
      const regex =
  ...
  describe("mergeConfig", () => {
    ...
    it("should merge dependencies by identifier", () => {
      ...
      expect(
        merged.dependencies.find((d) => d.identifier === "api-2"),
      ).toBeDefined();
    });
